...
const History = () => {
    ...
    return(
        <Box  mt={2} ml={3} mr={3}> 
            ...
            <Grid>
                <Grid container>
                    <h1 style={{color:'white'}}>Top 5 canciones más reproducidas</h1>
                </Grid>
            </Grid>
            ...
            <Grid>
                <Grid container>
                    <h1 style={{color:'white'}}>Top 3 artistas más escuchados</h1>
                </Grid>
            </Grid>
            <Grid container  columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Button onClick={(e) => llamarcancion(e)}>
            ...
            <Grid>
                <Grid container>
                    <h1 style={{color:'white'}}>Top 5 albumes más reproducidos</h1>
                </Grid>
            </Grid>
            <Grid container  columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Button onClick={(e) => llamarcancion(e)}>
            ...
            <Grid>
                <Grid container>
                    <h1 style={{color:'white'}}>Historial de Canciones Reproducidas</h1>
                </Grid>
            </Grid>
            <Grid container  columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Button onClick={(e) => llamarcancion(e)}>
